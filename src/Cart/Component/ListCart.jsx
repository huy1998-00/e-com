              ...
              <tr className="text-center" key={index}>
                <td className="pl-0 border-0">
                  <div className="media align-items-center justify-content-center">
                    ...
                    >
                      <img src={value.idProduct.img1} alt="..." width="70" />
                    </Link>
                  </div>
                </td>
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    {convertMoney(value.idProduct.price)} VND
                  </p>
                </td>
                <td className="align-middle border-0">
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    {convertMoney(
                      parseInt(value.idProduct.price) * parseInt(value.count)
                    )}{" "}
                    VND
                  </p>
                </td>
                <td className="align-middle border-0">
                  <a
                    ...
                    style={{ cursor: "pointer" }}
                    onClick={() =>
                      handlerDelete(value.idUser, value.idProduct._id)
                    }
                  >
