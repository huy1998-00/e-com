      ...
      <div className="table-responsive pt-5 pb-5">
        <table className="table">
          ...
          <tbody>
            {cart &&
              cart.map((value) => (
                <tr className="text-center" key={value.idProduct._id}>
                  <td className="align-middle border-0">
                    <h6 className="mb-0">{value.idProduct._id}</h6>
                  </td>
                  <td className="pl-0 border-0">
                    <div className="media align-items-center justify-content-center">
                      <Link
                        className="reset-anchor d-block animsition-link"
                        to={`/detail/${value.idProduct._id}`}
                      >
                        <img src={value.idProduct.img1} alt="..." width="200" />
                      </Link>
                    </div>
                  </td>
                  <td className="align-middle border-0">
                    <h6 className="mb-0">{value.idProduct.name}</h6>
                  </td>
                  <td className="align-middle border-0">
                    <h6 className="mb-0">{value.idProduct.price}</h6>
                  </td>
                  <td className="align-middle border-0">
